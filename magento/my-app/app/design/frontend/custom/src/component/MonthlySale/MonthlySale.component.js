...
// import { decrementMonthlySale, incrementMonthlySale } from 'Store/MonthlySale/MonthlySale.action';
...
export class MonthlySaleComponents extends PureComponent {
    ...
    handleIncrement() {
        ...
        // this.dispatch(incrementMonthlySale)
    }

    handleDecrement() {
        const { decrement } = this.props;
        if (decrement) decrement();
        // this.dispatch(decrementMonthlySale)
    }
