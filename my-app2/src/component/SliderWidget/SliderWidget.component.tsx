...
import { SliderWidgetComponentProps, SliderWidgetComponentState, SlideWithPlaceholder } from './SliderWidget.type';
...
export class SliderWidgetComponent extends PureComponent<SliderWidgetComponentProps, SliderWidgetComponentState> {
    ...
    getSlideText(i: number): string {
        if (i === 0) {
            return 'First Slide Text';
        }
        if (i === 1) {
            return 'Second Slide Text';
        }
        return 'Other Slides';
    }
        ...
        return (
            <figure block="SliderWidget" elem="Figure" key={ i }>
                ...
                <figcaption block="SliderWidget" elem="Figcaption" mix={ { block } }>
                    <Html content={ this.getSlideText(i) } />
                </figcaption>
            </figure>
        );
    }
...
function getSlideText(i: number, number: any) {
